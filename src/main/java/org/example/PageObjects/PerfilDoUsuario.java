...
public class PerfilDoUsuario {
    ...
    public void buscarElementos() {
        ...
        dadosPessoais = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@text=\"DADOS PESSOAIS\"]");
    ...
    public void clickEditarFoto() {
        ...
        botaoEditarFoto = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@text=\"EDITAR\"]");
        botaoEditarFoto.click();
    }

    public void clickBotaoTirarFoto() {
        WebDriverWait espera = new WebDriverWait(driver, 10);
        botaoTirarFoto = (MobileElement) espera.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.view.ViewGroup[@content-desc=\"Botão para abrir a câmera.\"]/android.view.ViewGroup")));
        botaoTirarFoto.click();
    }

    public void permitirAcessoCamera() {
        WebDriverWait espera = new WebDriverWait(driver, 10);
        MobileElement permitirAcessoCamera = (MobileElement) espera.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.Button[@resource-id=\"com.android.permissioncontroller:id/permission_allow_one_time_button\"]\n")));
