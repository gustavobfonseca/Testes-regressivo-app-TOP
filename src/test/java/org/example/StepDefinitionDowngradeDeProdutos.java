...
public class StepDefinitionDowngradeDeProdutos {
    ...
    public void douScrollAtéCancelarCartaoOuContaDigital() {
        tela.scrollAteElemento("//android.widget.TextView[@text=\"DADOS PESSOAIS\"]", 10, "new UiSelector().text(\"Cancelar Cartão ou Conta Digital\")");

    }

    @E("clico em Cancelar Cartao Ou Conta Digital")
    public void clicoEmCancelarCartaoOuContaDigital() {
        tela.clicarEmElemento("//android.widget.TextView[@text=\"Cancelar Cartão ou Conta Digital\"]", 10);
    }

    @E("clico em Cartao De Credito TOP")
    public void clicoEmCartaoDeCreditoTOP() {
        tela.clicarEmElemento("//android.widget.TextView[@text=\"Cartão de Crédito TOP\"]", 60);
    }
    ...
    public void clicoEmCancelarOCartaoDeCredito() {
        tela.scrollAteElemento("//android.widget.TextView[@text=\"Poxa! Tem certeza que deseja cancelar\n" +
                "a função Crédito TOP Mastercard?\"]", 10, "new UiSelector().text(\"CANCELAR O CARTÃO DE CRÉDITO\")");
        tela.clicarEmElemento("//android.widget.TextView[@content-desc=\"CANCELAR O CARTÃO DE CRÉDITO\"]", 10);
